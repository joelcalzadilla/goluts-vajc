...
class tpv_comanda extends fs_model
{
    ...
    public function all_from_arqueo($ida, $date_from = null, $limit = null)
    {
        $clist = array();
        $sql = "SELECT * FROM tpv_comandas"
            . " WHERE idtpv_arqueo = " . $this->var2str($ida)
            . ($date_from ? (" AND fecha >= '" . $date_from . "'") : "")
