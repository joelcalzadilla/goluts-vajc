...
class ventas_articulo extends fbase_controller
{
    ...
    private function modificar_articulo()
    {
        ...
        $this->articulo->distribuidora = $_POST['distribuidora'];
        $this->articulo->reservas = $_POST['reservas'];
        $this->articulo->fecha_recepcion = $_POST['fecha_recepcion'];
        $this->articulo->num_ultimo_recibido = $_POST['num_ultimo_recibido'];
        $this->articulo->uds_recibidas_ult_reparto = $_POST['uds_recibidas_ult_reparto'];
        $this->articulo->stock_vendido_ult_recepcion = $_POST['stock_vendido_ult_recepcion'];
        $this->articulo->num_anterior = $_POST['num_anterior'];
        $this->articulo->uds_num_anterior = $_POST['uds_num_anterior'];
        $this->articulo->num_anterior_del_anterior = $_POST['num_anterior_del_anterior'];
        $this->articulo->uds_num_anterior_del_anterior = $_POST['uds_num_anterior_del_anterior'];
        $this->articulo->fcodigo = $_POST['fcodigo'];
        $this->articulo->notas = $_POST['notas'];
        ...
        if (isset($_POST['devuelto_descatalogado'])) {
            $this->articulo->devuelto_descatalogado = 1;
        } else {
            $this->articulo->devuelto_descatalogado = 0;
        }
