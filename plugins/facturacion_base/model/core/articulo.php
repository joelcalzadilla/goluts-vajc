...
class articulo extends \fs_model
{
    ...
    public $num_ultimo_recibido;
    public $uds_recibidas_ult_reparto;
    public $stock_vendido_ult_recepcion;
    public $num_anterior;
    public $uds_num_anterior;
    public $num_anterior_del_anterior;
    public $uds_num_anterior_del_anterior;
    public $pvp_anterior;
    public $fcodigo;
    public $notas;
    public $devuelto_descatalogado;
    ...
    public function __construct($data = FALSE)
    {
        ...
        if (!isset(self::$impuestos)) {
            ...
            self::$column_list = 'referencia,codfamilia,codfabricante,descripcion,pvp,factualizado,costemedio,' .
                ...
                'secompra,sevende,equivalencia,codbarras,observaciones,distribuidora,reservas,' .
                'fecha_recepcion,num_ultimo_recibido,uds_recibidas_ult_reparto,stock_vendido_ult_recepcion,' .
                'num_anterior,uds_num_anterior,num_anterior_del_anterior,uds_num_anterior_del_anterior,pvp_anterior,' .
                'fcodigo,notas,devuelto_descatalogado,imagen,publico,tipo,partnumber,codsubcuentacom,codsubcuentairpfcom,trazabilidad';
        }
        ...
        if ($data) {
            ...
            $this->num_ultimo_recibido = $data['num_ultimo_recibido'];
            $this->uds_recibidas_ult_reparto = $data['uds_recibidas_ult_reparto'];
            $this->stock_vendido_ult_recepcion = $data['stock_vendido_ult_recepcion'];
            $this->num_anterior = $data['num_anterior'];
            $this->uds_num_anterior = $data['uds_num_anterior'];
            $this->num_anterior_del_anterior = $data['num_anterior_del_anterior'];
            $this->uds_num_anterior_del_anterior = $data['uds_num_anterior_del_anterior'];
            $this->pvp_anterior = $data['pvp_anterior'];
            $this->fcodigo = $data['fcodigo'];
            $this->notas = $data['notas'];
            $this->devuelto_descatalogado = $data['devuelto_descatalogado'];
            ...
            $this->num_ultimo_recibido = '';
            $this->uds_recibidas_ult_reparto = '';
            $this->stock_vendido_ult_recepcion = '';
            $this->num_anterior = '';
            $this->uds_num_anterior = '';
            $this->num_anterior_del_anterior = '';
            $this->uds_num_anterior_del_anterior = '';
            $this->pvp_anterior = '';
            $this->fcodigo = '';
            $this->notas = '';
            $this->devuelto_descatalogado = 0;
    ...
    public function pvp_iva_format()
    {
        return number_format($this->pvp_iva(), 2, '.', '');
    }
        ...
        if ($this->test()) {
            ...
            if ($this->exists()) {
                $sql = "UPDATE " . $this->table_name . " SET descripcion = " . $this->var2str($this->descripcion) .
                    ...
                    ", distribuidora = " . $this->var2str($this->distribuidora) .
                    ", reservas = " . $this->var2str($this->reservas) .
                    ", fecha_recepcion = " . $this->var2str($this->fecha_recepcion) .
                    ", num_ultimo_recibido = " . $this->var2str($this->num_ultimo_recibido) .
                    ", uds_recibidas_ult_reparto = " . $this->var2str($this->uds_recibidas_ult_reparto) .
                    ", stock_vendido_ult_recepcion = " . $this->var2str($this->stock_vendido_ult_recepcion) .
                    ", num_anterior = " . $this->var2str($this->num_anterior) .
                    ", uds_num_anterior = " . $this->var2str($this->uds_num_anterior) .
                    ", num_anterior_del_anterior = " . $this->var2str($this->num_anterior_del_anterior) .
                    ", uds_num_anterior_del_anterior = " . $this->var2str($this->uds_num_anterior_del_anterior) .
                    ", pvp_anterior = " . $this->var2str($this->pvp_anterior) .
                    ", fcodigo = " . $this->var2str($this->fcodigo) .
                    ", notas = " . $this->var2str($this->notas) .
                    ", devuelto_descatalogado = " . $this->var2str($this->devuelto_descatalogado) .
                ...
                $sql = "INSERT INTO " . $this->table_name . " (" . self::$column_list . ") VALUES (" .
                    ...
                    $this->var2str($this->distribuidora) . "," .
                    $this->var2str($this->reservas) . "," .
                    $this->var2str($this->fecha_recepcion) . "," .
                    $this->var2str($this->num_ultimo_recibido) . "," .
                    $this->var2str($this->uds_recibidas_ult_reparto) . "," .
                    $this->var2str($this->stock_vendido_ult_recepcion) . "," .
                    $this->var2str($this->num_anterior) . "," .
                    $this->var2str($this->uds_num_anterior) . "," .
                    $this->var2str($this->num_anterior_del_anterior) . "," .
                    $this->var2str($this->uds_num_anterior_del_anterior) . "," .
                    $this->var2str($this->pvp_anterior) . "," .
                    $this->var2str($this->fcodigo) . "," .
                    $this->var2str($this->notas) . "," .
                    $this->var2str($this->devuelto_descatalogado) . "," .
